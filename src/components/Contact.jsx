    ...
    <section id="contact" className="py-24 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={ref} className="text-center mb-16">
          ...
          >
            Ready to sign up or have questions? Fill in the form and we'll get back to you
          ...
          >
            {contactInfo.map(({ icon: Icon, label, value, sub, href }) => (
              ...
              >
                ...
                <div>
                  <div className="text-slate-500 text-xs font-semibold uppercase tracking-widest mb-1">{label}</div>
                  {href ? (
                    <a href={href} className="font-semibold text-white hover:text-brand-400 transition-colors">
                      {value}
                    </a>
                  ) : (
            ...
            <div className="glass-strong border border-brand-500/20 rounded-2xl p-5 mt-2">
              <div className="text-brand-400 font-semibold text-sm mb-1">Check Your Coverage</div>
              <p className="text-slate-400 text-xs leading-relaxed">
                Call us with your address or mention it in the message form and we'll instantly verify
                if PACIFICWEB service is available at your location.
              </p>
            </div>
          </motion.div>
              ...
              {status === 'success' ? (
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    ...
                    <div>
                      <label className="block text-xs font-semibold text-slate-400 mb-2 uppercase tracking-wider">
                        Connection Type <span className="text-brand-500">*</span>
                      </label>
                      <select
                        name="type"
                        value={form.type}
